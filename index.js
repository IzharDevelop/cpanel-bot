...
// Hapus atau setel pairingCode menjadi false secara eksplisit
const pairingCode = false; // Baris ini memastikan hanya QR code yang digunakan
const rl = readline.createInterface({ input: process.stdin, output: process.stdout })
const question = (text) => new Promise((resolve) => rl.question(text, resolve))
let pairingStarted = false;
let phoneNumber; // Tidak lagi dibutuhkan untuk QR code saja
...
async function startNazeBot() {
    ...
    // Bagian ini dihapus karena pairingCode sudah diatur false
    /*
    ...
    */
    ...
    naze.ev.on('connection.update', async (update) => {
        ...
        // Baris ini memastikan QR code ditampilkan
        if (qr) {
        ...
        // Bagian pairing code yang dihapus
        /*
